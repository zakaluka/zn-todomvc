...
var _user$project$ZnTodoMVC$viewTaskSummary = function (entry) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$core$Native_Utils.eq(entry.completedOn, '') ? _elm_lang$html$Html_Attributes$class('g--3 g-m--4 g-s--6 g-t--12 tile') : _elm_lang$html$Html_Attributes$class(
				A2(_elm_lang$core$Basics_ops['++'], 'g--3 g-m--4 g-s--6 g-t--12 tile ', 'bg--purple color--white')),
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(entry.subject)
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(entry.createdOn)
					])),
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(entry.completedOn)
					]))
			]));
};
var _user$project$ZnTodoMVC$viewTaskSummaries = function (mdl) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('g--12 container container--wrap')
			]),
		A2(
			_elm_lang$core$List$map,
			_user$project$ZnTodoMVC$viewTaskSummary,
			A2(
				_elm_lang$core$List$sortWith,
				F2(
					function (x, y) {
						return (_elm_lang$core$Native_Utils.eq(x.completedOn, '') && _elm_lang$core$Native_Utils.eq(y.completedOn, '')) ? A2(_elm_lang$core$Basics$compare, x.createdOn, y.createdOn) : A2(_elm_lang$core$Basics$compare, x.completedOn, y.completedOn);
					}),
				mdl.appModel.entries)));
};
var _user$project$ZnTodoMVC$viewFooter = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('nudge--left')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Some stuff')
							]))
					]))
			]));
};
var _user$project$ZnTodoMVC$viewHeader = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('nudge--left g--12')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$ZnTodoMVC$newEntry = F3(
	function (sub, desc, id) {
		return {subject: sub, body: desc, createdOn: '', completedOn: '', editing: false, id: id};
	});
var _user$project$ZnTodoMVC$createTaskModel = {subject: '', body: '', hide: true};
var _user$project$ZnTodoMVC$appModel = {
	entries: _elm_lang$core$Native_List.fromArray(
		[]),
	visibility: 'All',
	uuid: 0
};
var _user$project$ZnTodoMVC$emptyModel = {appModel: _user$project$ZnTodoMVC$appModel, createTaskModel: _user$project$ZnTodoMVC$createTaskModel};
var _user$project$ZnTodoMVC$init = function (savedModel) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		A2(_elm_lang$core$Maybe$withDefault, _user$project$ZnTodoMVC$emptyModel, savedModel),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
var _user$project$ZnTodoMVC$setStorage = _elm_lang$core$Native_Platform.outgoingPort(
	'setStorage',
	function (v) {
		return {
			appModel: {
				entries: _elm_lang$core$Native_List.toArray(v.appModel.entries).map(
					function (v) {
						return {subject: v.subject, body: v.body, createdOn: v.createdOn, completedOn: v.completedOn, editing: v.editing, id: v.id};
					}),
				uuid: v.appModel.uuid,
				visibility: v.appModel.visibility
			},
			createTaskModel: {subject: v.createTaskModel.subject, body: v.createTaskModel.body, hide: v.createTaskModel.hide}
		};
	});
var _user$project$ZnTodoMVC$Model = F2(
	function (a, b) {
		return {appModel: a, createTaskModel: b};
	});
var _user$project$ZnTodoMVC$AppModel = F3(
	function (a, b, c) {
		return {entries: a, uuid: b, visibility: c};
	});
var _user$project$ZnTodoMVC$EntryModel = F6(
	function (a, b, c, d, e, f) {
		return {subject: a, body: b, createdOn: c, completedOn: d, editing: e, id: f};
	});
var _user$project$ZnTodoMVC$CreateTaskModel = F3(
	function (a, b, c) {
		return {subject: a, body: b, hide: c};
	});
var _user$project$ZnTodoMVC$Completion = {ctor: 'Completion'};
var _user$project$ZnTodoMVC$Creation = {ctor: 'Creation'};
var _user$project$ZnTodoMVC$TaskSubjectSort = {ctor: 'TaskSubjectSort'};
var _user$project$ZnTodoMVC$TaskCompletionSort = {ctor: 'TaskCompletionSort'};
var _user$project$ZnTodoMVC$TaskCreationSort = {ctor: 'TaskCreationSort'};
var _user$project$ZnTodoMVC$SortTasks = function (a) {
	return {ctor: 'SortTasks', _0: a};
};
var _user$project$ZnTodoMVC$sortButtons = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_elm_lang$html$Html$button,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('btn--raised'),
				_elm_lang$html$Html_Events$onClick(
				_user$project$ZnTodoMVC$SortTasks(_user$project$ZnTodoMVC$TaskSubjectSort))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('Subject')
			])),
		A2(
		_elm_lang$html$Html$button,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('btn--raised'),
				_elm_lang$html$Html_Events$onClick(
				_user$project$ZnTodoMVC$SortTasks(_user$project$ZnTodoMVC$TaskCreationSort))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('Created On')
			])),
		A2(
		_elm_lang$html$Html$button,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('btn--raised nudge--right'),
				_elm_lang$html$Html_Events$onClick(
				_user$project$ZnTodoMVC$SortTasks(_user$project$ZnTodoMVC$TaskCompletionSort))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('Completed On')
			]))
	]);
var _user$project$ZnTodoMVC$SetDate = F3(
	function (a, b, c) {
		return {ctor: 'SetDate', _0: a, _1: b, _2: c};
	});
var _user$project$ZnTodoMVC$setTaskDate = F2(
	function (id, dm) {
		return A3(
			_elm_lang$core$Task$perform,
			_elm_lang$core$Basics$always(
				A3(
					_user$project$ZnTodoMVC$SetDate,
					id,
					dm,
					A2(
						...
						A2(
							...
							_rluiten$elm_date_extra$Date_Extra_Format$utcIsoString,
							_elm_lang$core$Date$fromString('2015-01-01 00:00:00.000Z'))))),
			function (_p0) {
				return A3(
					_user$project$ZnTodoMVC$SetDate,
					id,
					dm,
					_rluiten$elm_date_extra$Date_Extra_Format$utcIsoString(_p0));
			},
			_elm_lang$core$Date$now);
	});
var _user$project$ZnTodoMVC$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'Reset':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_user$project$ZnTodoMVC$emptyModel,
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'NoOp':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'Add':
				var ctm = model.createTaskModel;
				var am = model.appModel;
				var ctm2 = _elm_lang$core$Native_Utils.update(
					ctm,
					{subject: '', body: '', hide: true});
				var am2 = _elm_lang$core$Native_Utils.update(
					am,
					{
						uuid: am.uuid + 1,
						entries: A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									A3(_user$project$ZnTodoMVC$newEntry, ctm.subject, ctm.body, am.uuid)
								]))
					});
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{appModel: am2, createTaskModel: ctm2}),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_user$project$ZnTodoMVC$setTaskDate, am.uuid, _user$project$ZnTodoMVC$Creation)
						]));
			case 'CTHideDialog':
				var ctm = model.createTaskModel;
				var ctm2 = _elm_lang$core$Native_Utils.update(
					ctm,
					{
						hide: _elm_lang$core$Basics$not(ctm.hide),
						subject: '',
						body: ''
					});
				return A2(
			...
			case 'SetDate':
				var _p3 = _p1._2;
				var upd = function (entry) {
					if (_elm_lang$core$Native_Utils.eq(entry.id, _p1._0)) {
						var _p2 = _p1._1;
						if (_p2.ctor === 'Creation') {
				...
				var am2 = _elm_lang$core$Native_Utils.update(
					am,
					{
						entries: A2(_elm_lang$core$List$map, upd, am.entries)
					});
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
			...
			default:
				return _elm_lang$core$Native_Utils.crashCase(
					'ZnTodoMVC',
					{
						start: {line: 185, column: 5},
						end: {line: 285, column: 36}
					},
					_p1)('SortTasks');
		}
	});
var _user$project$ZnTodoMVC$updateWithStorage = F2(
	function (msg, model) {
		var _p5 = A2(_user$project$ZnTodoMVC$update, msg, model);
		var newModel = _p5._0;
		var cmds = _p5._1;
		return {
			ctor: '_Tuple2',
			...
			_1: _elm_lang$core$Platform_Cmd$batch(
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$ZnTodoMVC$setStorage(newModel),
						cmds
					]))
		};
	});
var _user$project$ZnTodoMVC$Reset = {ctor: 'Reset'};
var _user$project$ZnTodoMVC$resetButton = A2(
	_elm_lang$html$Html$button,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('btn--raised btn--red nudge--right'),
			_elm_lang$html$Html_Events$onClick(_user$project$ZnTodoMVC$Reset)
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html$text('Reset')
		]));
var _user$project$ZnTodoMVC$NoOp = {ctor: 'NoOp'};
var _user$project$ZnTodoMVC$CTUpdateSubject = function (a) {
	return {ctor: 'CTUpdateSubject', _0: a};
};
var _user$project$ZnTodoMVC$CTUpdateBody = function (a) {
	return {ctor: 'CTUpdateBody', _0: a};
};
var _user$project$ZnTodoMVC$CTHideDialog = {ctor: 'CTHideDialog'};
var _user$project$ZnTodoMVC$createButton = A2(
	_elm_lang$html$Html$button,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('btn--raised nudge--right'),
			_elm_lang$html$Html_Events$onClick(_user$project$ZnTodoMVC$CTHideDialog)
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html$text('What do you need to do today?')
		]));
var _user$project$ZnTodoMVC$Add = {ctor: 'Add'};
var _user$project$ZnTodoMVC$createTaskForm = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('card g--3 g-m--4 g-s--6 g-t--12 no-margin fade-in-from-top'),
				_elm_lang$html$Html_Attributes$hidden(model.createTaskModel.hide)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('g--12 no-margin-vertical')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Create a new task')
							])),
						A2(
						_elm_lang$html$Html$input,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$placeholder('Subject'),
								_elm_lang$html$Html_Attributes$autofocus(true),
								_elm_lang$html$Html_Attributes$type$('text'),
								_elm_lang$html$Html_Attributes$required(true),
								_elm_lang$html$Html_Attributes$value(model.createTaskModel.subject),
								_elm_lang$html$Html_Events$onInput(_user$project$ZnTodoMVC$CTUpdateSubject),
								_elm_lang$html$Html_Attributes$class('g--12 no-margin-vertical')
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$required(true),
								_elm_lang$html$Html_Attributes$placeholder('Detailed description'),
								_elm_lang$html$Html_Attributes$required(true),
								_elm_lang$html$Html_Attributes$wrap('hard'),
								_elm_lang$html$Html_Attributes$value(model.createTaskModel.body),
								_elm_lang$html$Html_Events$onInput(_user$project$ZnTodoMVC$CTUpdateBody),
								_elm_lang$html$Html_Attributes$class('g--12 m--0 no-margin-vertical'),
								_elm_lang$html$Html_Attributes$rows(5)
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('btn--raised'),
								_elm_lang$html$Html_Events$onClick(_user$project$ZnTodoMVC$Add)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Create task')
							])),
						A2(
						_elm_lang$html$Html$span,
						_elm_lang$core$Native_List.fromArray(
...
var _user$project$ZnTodoMVC$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('g--12 no-pad no-margin-vertical')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$html$Html_Lazy$lazy, _user$project$ZnTodoMVC$viewHeader, model),
				A3(
				_elm_lang$html$Html_Lazy$lazy2,
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('nudge--left g--12 no-pad no-margin-vertical')
					]),
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Native_List.fromArray(
						[_user$project$ZnTodoMVC$createButton]),
					A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$ZnTodoMVC$sortButtons,
						_elm_lang$core$Native_List.fromArray(
							[
								_user$project$ZnTodoMVC$resetButton,
								_user$project$ZnTodoMVC$createTaskForm(model),
								_user$project$ZnTodoMVC$viewTaskSummaries(model)
							])))),
				A2(_elm_lang$html$Html_Lazy$lazy, _user$project$ZnTodoMVC$viewFooter, model)
			]));
};
var _user$project$ZnTodoMVC$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{
			init: _user$project$ZnTodoMVC$init,
			view: _user$project$ZnTodoMVC$view,
			update: _user$project$ZnTodoMVC$updateWithStorage,
					...
					A2(
						...
						A2(
								...
								_elm_lang$core$Json_Decode$list(
									A2(
										...
										function (body) {
											return A2(
												_elm_lang$core$Json_Decode$andThen,
												A2(_elm_lang$core$Json_Decode_ops[':='], 'completedOn', _elm_lang$core$Json_Decode$string),
												function (completedOn) {
													return A2(
														_elm_lang$core$Json_Decode$andThen,
														A2(_elm_lang$core$Json_Decode_ops[':='], 'createdOn', _elm_lang$core$Json_Decode$string),
														function (createdOn) {
															return A2(
																_elm_lang$core$Json_Decode$andThen,
																			...
																			return A2(
																				...
																				function (subject) {
																					return _elm_lang$core$Json_Decode$succeed(
																						{body: body, completedOn: completedOn, createdOn: createdOn, editing: editing, id: id, subject: subject});
																				});
																		});
																});
														});
							...
							function (entries) {
								return A2(
									_elm_lang$core$Json_Decode$andThen,
									A2(_elm_lang$core$Json_Decode_ops[':='], 'uuid', _elm_lang$core$Json_Decode$int),
									function (uuid) {
										return A2(
											_elm_lang$core$Json_Decode$andThen,
											...
											function (visibility) {
												return _elm_lang$core$Json_Decode$succeed(
													{entries: entries, uuid: uuid, visibility: visibility});
											});
									});
							})),
					function (appModel) {
							...
							A2(
								...
								A2(
									...
									function (body) {
										return A2(
											_elm_lang$core$Json_Decode$andThen,
											A2(_elm_lang$core$Json_Decode_ops[':='], 'hide', _elm_lang$core$Json_Decode$bool),
											function (hide) {
												return A2(
													_elm_lang$core$Json_Decode$andThen,
													A2(_elm_lang$core$Json_Decode_ops[':='], 'subject', _elm_lang$core$Json_Decode$string),
													function (subject) {
														return _elm_lang$core$Json_Decode$succeed(
															{body: body, hide: hide, subject: subject});
													});
											});
									})),
							function (createTaskModel) {
								return _elm_lang$core$Json_Decode$succeed(
									{appModel: appModel, createTaskModel: createTaskModel});
							});
					}))
			]))
};
...
var Elm = {};
Elm['ZnTodoMVC'] = Elm['ZnTodoMVC'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['ZnTodoMVC'], 'ZnTodoMVC', typeof _user$project$ZnTodoMVC$main === 'undefined' ? null : _user$project$ZnTodoMVC$main);
